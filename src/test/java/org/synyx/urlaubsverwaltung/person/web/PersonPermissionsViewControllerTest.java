...
class PersonPermissionsViewControllerTest {
    ...
    void editPersonPermissionsCorrectly() throws Exception {
        ...
        when(personService.updatePermissions(new PersonId(1), List.of(USER, OFFICE))).thenReturn(person);
    ...
    void editPersonPermissionsAddsFlashAttribute() throws Exception {
        ...
        when(personService.updatePermissions(new PersonId(1), List.of())).thenReturn(person);
