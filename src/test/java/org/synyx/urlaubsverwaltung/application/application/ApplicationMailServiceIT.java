...
class ApplicationMailServiceIT extends TestContainersBase {
    ...
    void ensureNotificationAboutAllowedApplicationIsSentToApplicantManagementAndColleague() throws Exception {
        ...
        colleague.setId(42);
        when(mailRecipientService.getRecipientsOfInterest(application.getPerson(), NOTIFICATION_EMAIL_COLLEAGUES)).thenReturn(List.of(colleague));
        ...
        // check email colleague attributes
        ...
        assertThat(readPlainContent(msgColleague)).isEqualTo("Hallo Hans Dampf," + EMAIL_LINE_BREAK +
                ...
                EMAIL_LINE_BREAK +
                "Wenn du diese Benachrichtigung nicht mehr erhalten möchtest, kannst du das hier einstellen: https://localhost:8080/web/person/42/notifications"+ EMAIL_LINE_BREAK
        );
